...
# Test the final fix with realistic data structures
println("=== Testing Final Fix ===")

# Include the visualization module
include("../src/visualization.jl")

# Create test data with different array lengths (simulating real results)
test_results = [
...
for (func_name, func) in functions_to_test
    ...
    try
        ...
        if result !== nothing
            ...
            # Test savefig
            try
                savefig(result, "test_$(func_name).png")
