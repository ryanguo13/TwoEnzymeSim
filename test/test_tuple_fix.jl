...
# Test the tuple handling fix
println("=== Testing Tuple Handling Fix ===")

# Include the visualization module
include("../src/visualization.jl")

# Create test data with tuple elements (simulating the actual problem)
test_results = [
    ((1.0, 0.5, 2.0, 1.0, 1.5, 0.8, 2.5, 1.2), [5.0, 2.1, 1.8, 18.5, 14.2]),  # All scalars
    ((0.8, 1.2, 1.8, 0.9, 1.2, 1.0, 2.0, 1.5), [(4.8, 4.9), 2.3]),  # A is a tuple
    ((1.2, 0.8, 2.2, 1.1, 1.8, 0.7, 2.8, 1.1), [5.2, (1.9, 2.0), 2.1]),  # B is a tuple
    ((1.5, 1.0, 2.5, 1.2, 2.0, 0.9, 3.0, 1.3), [(5.5, 5.6), (2.5, 2.6), (2.2, 2.3), 19.0]),  # A, B, C are tuples
...
println("Testing with $(length(test_results)) results (including tuple elements)")
...
for (func_name, func) in functions_to_test
    ...
    try
        ...
        if result !== nothing
            ...
            # Test savefig
            try
                savefig(result, "test_tuple_$(func_name).png")
